CREATE TABLE study_sessions_v2 (
    ...
    session_type  TEXT    NOT NULL DEFAULT 'review'
                          CHECK (session_type IN ('review', 'learn', 'cram', 'flashcard', 'multiple_choice', 'type_answer', 'weak_drill')),
...
CREATE TABLE review_logs_v2 (
    ...
    mode               TEXT    NOT NULL DEFAULT 'review'
                               CHECK (mode IN ('review', 'learn', 'cram', 'preview', 'flashcard', 'multiple_choice', 'type_answer', 'weak_drill')),
